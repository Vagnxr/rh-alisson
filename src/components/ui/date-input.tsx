      ...
      <Popover open={open} onOpenChange={setOpen}>
        <PopoverTrigger asChild>
          <button
            ...
            className={cn(
              'absolute right-2 top-1/2 -translate-y-1/2 inline-flex h-7 w-7 items-center justify-center rounded-md text-muted-foreground hover:bg-accent hover:text-foreground',
              'disabled:cursor-not-allowed disabled:opacity-50',
            )}
            onClick={(e) => {
              e.preventDefault();
        ...
        <PopoverContent
          ...
          collisionPadding={12}
          className={cn(
            'flex w-auto flex-col rounded-xl border border-border bg-popover p-0 text-popover-foreground shadow-lg',
        ...
        >
          ...
          />
          <div className="flex gap-2 border-t border-border bg-popover p-2">
            <button
              type="button"
              onClick={handleToday}
              className="flex-1 rounded-md bg-muted px-3 py-1.5 text-sm font-medium text-foreground hover:bg-accent"
            >
              Hoje
            </button>
            <button
